...
from acrfinder import __version__, __author__, __title__
from os import path

here = path.abspath(path.dirname(__file__))

# main module source folder, will be used for imports as the main module
_main_module = 'acrfinder'
...
setup(
    ...
    url='https://github.com/blankdots/acrfinder',  # Optional
    ...
    packages=[_main_module, 'acrfinder/conf', 'acrfinder/schemas', 'acrfinder/utils'],
    ...
    entry_points={  # Optional
        'console_scripts': [
            'acr_finder=acrfinder.server:main',
        ],
    },

    project_urls={  # Optional
        'Source': 'https://github.com/blankdots/acrfinder',
    },
)
